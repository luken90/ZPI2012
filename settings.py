...
DATABASES = {
    'default': {
        ...
        'NAME': '192.168.1.30/DB11G.WORLD',                      # Or path to database file if using sqlite3.
        'USER': 'DAGMARA',                      # Not used with sqlite3.
...
MEDIA_ROOT = '/strona/mysite/webroot/'
...
STATIC_ROOT = '/strona/mysite/webroot/Pictures'
...
SECRET_KEY = 'nj-2pojjfn6-_tc#4c_+g%9ylk3=ic76*(9!l8u-%t(+@b&amp;x39'
